...
const EMNE_MAP: Record<string, string> = {
  service: "service",
  vinterlagring: "vinterlagring",
  blatur: "blatur",
  kjop: "kjop",
};
...
export const ContactSection = () => {
  ...
  // Preselect emne from URL params
  useEffect(() => {
    const emne = searchParams.get("emne");
    if (emne && EMNE_MAP[emne]) {
      setFormData((prev) => ({ ...prev, emne: EMNE_MAP[emne] }));
    }
  }, [searchParams]);
  ...
  return (
    <>
      <PageHero title="Kontakt oss" subtitle="Ta kontakt for service, vinterlagring, kjøp eller spørsmål. Vi svarer så raskt vi kan!" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs font-body text-muted-foreground">{ADDRESS}</p>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs font-body text-muted-foreground">{PHONE_DISPLAY}</p>
                  </div>
                </a>
                <a
                  href={`mailto:${EMAIL}`}
            ...
            >
              {submitted ? (
                ...
                >
                  ...
                  <Button variant="cta" size="lg" type="submit" className="w-full min-h-[60px] text-base">
