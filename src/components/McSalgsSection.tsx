...
export const McSalgsSection = () => {
  return (
    <section id="salgs" className="py-24 scroll-mt-20 bg-secondary/20 carbon-texture">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground font-body max-w-xl mx-auto">
            Vi har alltid et godt utvalg av brukte og nye motorsykler.
            Finansiering via Santander og Nordea.
          </p>
        </motion.div>
