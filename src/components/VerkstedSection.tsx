...
export const VerkstedSection = () => {
  return (
    <>
      <PageHero
        title="Verksted"
        subtitle="Autorisert Honda & Yamaha verksted med over 35 års erfaring. Vi utfører alt fra vanlig service til store reparasjoner."
        backgroundImage={verkstedImg}
      />
            ...
            <div>
              ...
              >
                ...
                <p className="text-muted-foreground font-body mb-8">
                  Vi er et velrennomert autorisert motorsykkelverksted med topp moderne
                  utstyr og oppdatert kompetanse.
                </p>
              </motion.div>
